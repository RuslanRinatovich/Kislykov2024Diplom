...
namespace RetrospektivaApp.Entities
{
    public class ServiceBasket
    {
        ...
        /// </summary>
        public static Dictionary<Service, BuyItem> GetBasket { get; } = new Dictionary<Service, BuyItem>();
        ...
        public static void AddProductInBasket(Service product)
        {
        ...
        public static void SetCount(Service product, int count)
        {
            if (GetBasket.ContainsKey(product))
            {
                int k = count;
        ...
        public static void DeleteProductFromBasket(Service product)
        {
            if (GetBasket.ContainsKey(product))
            {
                GetBasket.Remove(product);
